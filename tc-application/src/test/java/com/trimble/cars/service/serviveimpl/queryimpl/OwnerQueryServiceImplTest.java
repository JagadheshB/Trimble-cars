...
class OwnerQueryServiceImplTest {
    ...
    /**
     * Method under test:
     * {@link OwnerQueryServiceImpl#getCarStatusAndDetailsAndLeaseHistoryByOwnerId(Integer, CarStatus)}
     */
    @Test
    void testGetCarStatusAndDetailsAndLeaseHistoryByOwnerId() {
        // Arrange
        ...
        // Act
        Owner actualCarStatusAndDetailsAndLeaseHistoryByOwnerId = ownerQueryServiceImpl
                .getCarStatusAndDetailsAndLeaseHistoryByOwnerId(1, CarStatus.IDLE);

        // Assert
        verify(carQueryRepository).findByStatus(eq("IDLE"));
        verify(ownerQueryRepository).findById(eq(1));
        assertTrue(actualCarStatusAndDetailsAndLeaseHistoryByOwnerId.getCars().isEmpty());
        assertSame(owner, actualCarStatusAndDetailsAndLeaseHistoryByOwnerId);
    }
     ...
     */
    @Test
    void testGetCarStatusAndDetailsAndLeaseHistoryByOwnerId2() {
        // Arrange
        when(carQueryRepository.findByStatus(Mockito.<String>any()))
        ...
        assertThrows(ErrorException.class,
                () -> ownerQueryServiceImpl.getCarStatusAndDetailsAndLeaseHistoryByOwnerId(1, CarStatus.IDLE));
        verify(carQueryRepository).findByStatus(eq("IDLE"));
        verify(ownerQueryRepository).findById(eq(1));
    }
     ...
     */
    @Test
    void testGetCarStatusAndDetailsAndLeaseHistoryByOwnerId3() {
        // Arrange
        Owner owner = new Owner();
        owner.setCars(new ArrayList<>());
        owner.setEmail("jane.doe@example.org");
        ...
        // Act
        Owner actualCarStatusAndDetailsAndLeaseHistoryByOwnerId = ownerQueryServiceImpl
                .getCarStatusAndDetailsAndLeaseHistoryByOwnerId(1, null);
     ...
     */
    @Test
    void testGetCarStatusAndDetailsAndLeaseHistoryByOwnerId4() {
        // Arrange
        when(carQueryRepository.findByStatus(Mockito.<String>any())).thenReturn(new ArrayList<>());
        ...
        // Act
        Owner actualCarStatusAndDetailsAndLeaseHistoryByOwnerId = ownerQueryServiceImpl
                .getCarStatusAndDetailsAndLeaseHistoryByOwnerId(1, CarStatus.ON_LEASE);
     ...
     */
    @Test
    void testGetCarStatusAndDetailsAndLeaseHistoryByOwnerId5() {
        // Arrange
        when(carQueryRepository.findByStatus(Mockito.<String>any())).thenReturn(new ArrayList<>());
        ...
        // Act
        Owner actualCarStatusAndDetailsAndLeaseHistoryByOwnerId = ownerQueryServiceImpl
                .getCarStatusAndDetailsAndLeaseHistoryByOwnerId(1, CarStatus.ON_SERVICE);
    ...
    void testGetOwnerById() {
        ...
        // Act
        Owner actualOwnerById = ownerQueryServiceImpl.getOwnerById(1);

        // Assert
        verify(ownerQueryRepository).findById(eq(1));
        assertSame(owner, actualOwnerById);
    }
    ...
    /**
     * Method under test: {@link OwnerQueryServiceImpl#getAllOwners()}
     */
    @Test
    void testGetAllOwners() {
        // Arrange
        ArrayList<Owner> ownerList = new ArrayList<>();
        when(ownerQueryRepository.findAll()).thenReturn(ownerList);

        // Act
        List<Owner> actualAllOwners = ownerQueryServiceImpl.getAllOwners();

        // Assert
        verify(ownerQueryRepository).findAll();
    ...
    void testGetAllOwners2() {
        ...
        owner.setEmail("jane.doe@example.org");
        owner.setId(1);
        owner.setName("Received request to fetch all owners from the database.");
        owner.setPhoneNumber("6625550144");
        ...
        // Assert
        verify(ownerQueryRepository).findAll();
        assertEquals(1, actualAllOwners.size());
        assertSame(owner, actualAllOwners.get(0));
    }
