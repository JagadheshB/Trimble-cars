package com.trimble.cars.service.serviveimpl.commandimpl;
...
import com.trimble.cars.repository.commandrepository.CarCommandRepository;
import com.trimble.cars.repository.commandrepository.CustomerCommandRepository;
import com.trimble.cars.repository.commandrepository.LeaseCommandRepository;
...
class CustomerCommandServiceImplTest {
    ...
    void testUpdateCustomerById() {
        ...
        UpdateCustomerDetailsResponseDto buildResult = UpdateCustomerDetailsResponseDto.builder()
                ...
                .build();
        when(modelMapper.map(Mockito.<Object>any(), Mockito.<Class<UpdateCustomerDetailsResponseDto>>any()))
